CLASS lhc_zr_rap100_r_travelju2 DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    CONSTANTS:
...
CLASS lhc_zr_rap100_r_travelju2 IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zr_rap100_r_travelju2,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atravju2 FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_atrvj2_d FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
