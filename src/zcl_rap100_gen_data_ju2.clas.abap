"! This class is used to fill travel data into the table zrap100_atravJU2
CLASS zcl_rap100_gen_data_JU2 DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_JU2 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'JU2',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravJU2.
*    DELETE FROM zrap100_dtravJU2.

    "insert travel demo data
    INSERT zrap100_atravJU2  FROM (
        SELECT
