CLASS zrap100_cl_eml_JU2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap100_cl_eml_ju2 IMPLEMENTATION.
...
*        FROM VALUE #( ( %cid_ref = 'create_travel' %is_draft = instance_state ) )
    ...
    "persist changes
    COMMIT ENTITIES
      RESPONSE OF zr_rap100_r_travelju2
      FAILED DATA(failed_commit)
      REPORTED DATA(reported_commit).
